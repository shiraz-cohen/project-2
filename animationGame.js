...
async function myMove1() {
  ...
  /*  clearInterval(id); */
    ...
    await sleep(600);
    elem5.className = "color";
    id5 = setInterval(frame5, 30);
    await sleep(900);
    elem6.className = "color";
    id6 = setInterval(frame6, 30);
    await sleep(800);
    elem7.className = "color";
    id7 = setInterval(frame7, 30);
    await sleep(500);
    elem8.className = "color";
    id8 = setInterval(frame8, 30);
    await sleep(600);
    elem9.className = "color";
    id9 = setInterval(frame9, 30);
    await sleep(800);
    elem10.className = "color";
    id10 = setInterval(frame10, 30);
    await sleep(700);
